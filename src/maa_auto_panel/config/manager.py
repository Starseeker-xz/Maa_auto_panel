...
from maa_auto_panel.storage.trash import TrashManager, TrashRecord
from maa_auto_panel.utils import relative_path, resolve_existing_named_file, slugify, validate_file_name, write_text_atomic
...
def default_cli_config() -> dict[str, object]:
    return {
        "$schema": "https://github.com/MaaAssistantArknights/maa-cli/raw/v0.5.3/crates/maa-cli/schemas/cli.schema.json",
        "core": {
            "channel": "Stable",
            "test_time": 0,
