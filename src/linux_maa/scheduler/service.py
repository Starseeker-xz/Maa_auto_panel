...
from linux_maa.run_manager.manager import (
    GenericRunManager,
    RetryDecision,
    RunAttempt,
    RunCallbacks,
...
from linux_maa.run_manager.store import RunStateStore, StoredRun
from linux_maa.run_resources import adb_device_resources_from_profile, schedule_priority
...
class ScheduledMaaRunCallbacks:
    ...
    def evaluate_attempt(self, attempt: RunAttempt, result: StreamingProcessResult) -> RetryDecision:
        ...
        return RetryDecision(
            ...
            retry_artifacts={
                "generated_config_dir": relative_path(self.runtime.generated_config_dir / f"schedule-{attempt.run_id}", self.runtime.repo_root),
